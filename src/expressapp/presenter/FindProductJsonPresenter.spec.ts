...
import FindProductJsonPresenter from "./FindProductJsonPresenter";

describe("Present find product via Express in JSON format", () => {
    it("should send contents and 200 status code", () => {
        ...
        const presenter = new FindProductJsonPresenter(mockResponse as Response)
